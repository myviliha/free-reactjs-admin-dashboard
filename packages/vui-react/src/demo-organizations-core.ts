...
import { type DemoOrganization, organizations as seed } from "./demo-data-core";
...
export async function listOrganizations(signal?: AbortSignal): Promise<DemoOrganization[]> {
  await wait(signal);
  return [...rows];
}
