...
export function ThemeConfigProvider({
  ...
  const theme = React.useMemo(() => mergeThemes(org, userTheme), [org, userTheme]);
  ...
  React.useEffect(() => {
    ...
    const loaded = getComputedStyle(document.documentElement).getPropertyValue(family.variable);
    if (loaded.trim() === "")
      console.warn(
