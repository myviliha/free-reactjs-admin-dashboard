 ...
 */
export const DEMO_SOCIALS: { name: string; path: string; box: string }[] = [
  {
    name: "Facebook",
    box: "8.5 6.5 7 14.5",
 ...
 */
export const DEMO_PROFILE_FIELDS: readonly ProfileField[] = [
...
export const DEMO_ADDRESS_FIELDS: readonly ProfileField[] = [
