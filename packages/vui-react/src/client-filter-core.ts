import type { FilterValues } from "./record-field-core";
 ...
 */
export function matchFilters<T>(rows: T[], filters: FilterValues<T>): T[] {
 ...
 */
export function isBlankRow<T extends { id: number | string }>(row: T): boolean {
