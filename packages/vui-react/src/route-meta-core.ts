...
export const ROUTE_COLORS: Record<string, string> = {
  ...
  "/data-table/basic": "text-amber-500",
  "/data-table": "text-orange-500",
  "/forms": "text-teal-500",
...
// Group parent to first child, derived from the shared navigation tree, so breadcrumbs never need
// per-section wiring here.
import { sectionIndex } from "./nav-core";
