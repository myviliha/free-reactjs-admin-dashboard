...
export const PLAN_PLEDGE =
  "Every version already published is MIT permanently, so anything you have installed stays yours under the licence it shipped with, forever, including RecordView up to 1.66. What changes is where new work goes.";
