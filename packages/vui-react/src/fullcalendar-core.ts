 ...
 */
export function calendarSeedEvents(): Array<{
  id: string;
  title: string;
  start: string;
  end?: string;
...
export const fullcalendarEventClass = (level: string) =>
  `event-fc-color fc-event-main flex fc-bg-${String(level).toLowerCase()}`;
