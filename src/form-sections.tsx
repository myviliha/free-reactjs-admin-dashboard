...
export function DefaultInputs() {
  ...
  /*
   * Today, in the initialiser (`PD-159`).
   *
   * It was set on mount, because a static export bakes a value computed while rendering and a demo
   * opened a day later would hydrate against a different date. Nothing is prerendered now, so the
   * clock is read once, here, and the field is filled on first paint.
   */
