 ...
 *
 * **The router is injected rather than imported by the package.** `packages/react` has no router
 * import anywhere, and a design system sold to Vue, Angular, HTML and Laravel buyers must not gain
 * one. So `Link` and `pathname` are passed in from here, where react-router actually is.
 */
